...
public class SimulationDriver {
    public static void main(String[] args) {
        ...
        int numStudents = random.nextInt(20, 72);
        ...
        Question question3 = new Question("Multiple-choice", Arrays.asList("A", "B", "C", "D", "E"), true);
        ...
        Question question5 = new Question("Multiple-choice", Arrays.asList("A", "B", "C", "D", "E"), true);
    ...
    private static List<Student> generateStudents(int numStudents) {
        ...
        for (int i = 1; i <= numStudents; i++) {
            students.add(new Student("CS3560_CPP_" + i));
        }
